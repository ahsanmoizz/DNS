...
<task type="auto">
  ...
  <verify>Ensure moderation operations function correctly across endpoints</verify>
...
<task type="auto">
  ...
  <verify>Ensure backend sync is processed properly</verify>
...
<task type="auto">
  ...
  <verify>Ensure mail-control and audit-log views are accurate</verify>
